...
//                    System.out.println("[0:Geneve] [1:Lausanne] [2:Neuchatel] [3:Delemont] [4:Bale] [5:Berne] [6:Lucerne] [7:Zurich] [8:Schaffouse] [9:St.-Gall] [10:Coire] [11:St.-Moritz] [12:Bellinzone] [13:Andermatt] [14:Sion]");
                ...
                case 2:
                    // Matrices des poids
                    int[][] matrix = grapheCFF.getMatrixWeight(grapheCFF.arrayCitiesId.size());
...
//                    System.out.println("[Geneve:Lausanne:Berne:Zurich:Coire]"); // résultat pour Geneve à Coire
                ...
                case 8:
                    ...
                    idCitySrc = grapheCFF.arraySearchId.get(str1);

                    grapheCFF.generatePrecCostDijkstra(grapheCFF.arrayCitiesId.size(),idCitySrc);

                    System.out.println(grapheCFF.printCostDijkstra());
//                    System.out.println(grapheCFF.getListPrecDji());
                ...
                case 9:
                    ...
                    System.out.println(grapheCFF.printPrecDijkstra());
                    // format de sortie -> à généréer avec votre code
                ...
                case 10:
                    ...
                    idCitySrc = grapheCFF.arraySearchId.get(str1);
                    idCityDest = grapheCFF.arraySearchId.get(str2);

                    grapheCFF.generatePrecCostDijkstra(grapheCFF.arrayCitiesId.size(),idCitySrc);

                    grapheCFF.printCostDestDijkstra(idCityDest);
                ...
                case 11:
                    ...
                    grapheCFF.printPathDijkstra(idCitySrc, idCityDest);
